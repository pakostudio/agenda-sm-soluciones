...
create unique index if not exists google_calendar_connections_user_calendar_unique
on public.google_calendar_connections (user_id, calendar_id);
...
drop policy if exists "own google connection" on public.google_calendar_connections;
drop policy if exists "google connections admin only" on public.google_calendar_connections;
